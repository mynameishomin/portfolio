...
var PerspectiveOrigin = /*#__PURE__*/ function(Base) {
    "use strict";
    _inherits(PerspectiveOrigin, Base);
    var _super = _create_super(PerspectiveOrigin);
    function PerspectiveOrigin() {
        _class_call_check(this, PerspectiveOrigin);
        var _this;
...
_define_property(PerspectiveOrigin, "defaultTheme", _defaultTheme.default.transformOrigin);
