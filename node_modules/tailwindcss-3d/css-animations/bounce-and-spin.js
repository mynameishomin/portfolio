...
var BounceAndSpin = /*#__PURE__*/ function(Base) {
    "use strict";
    _inherits(BounceAndSpin, Base);
    var _super = _create_super(BounceAndSpin);
    function BounceAndSpin() {
        _class_call_check(this, BounceAndSpin);
        var _this;
        ...
        _define_property(_assert_this_initialized(_this), "normaliseValues", function(values) {
            return _this.isProcessableValues(values) ? (0, _lodash.chain)(values).mapKeys(function(_value, modifier) {
                ...
                return (0, _isString.default)(modifier) && modifier !== "" && (0, _isString.default)(duration) && (0, _isString.default)(distance);
            }).value() : {};
        });
        ...
        _define_property(_assert_this_initialized(_this), "keyframes", function(param) {
            ...
            var rotateDeclarations = function(axis, value) {
                ...
                var transformValue = _transform.Transform.normaliseFunctionValues(_define_property({}, rotateProperty, value));
                return {
            ...
            return (0, _lodash.chain)(values).transform((0, _lodashtransformers.axesModifier)()).transform((0, _lodashtransformers.nameModifier)("bounce-and-spin")).transform((0, _lodashtransformers.signModifier)()).mapValues(function(param) {
                ...
                return {
                    "0%, 100%": _object_spread_props(_object_spread({}, translateDeclarations(axis, "0")), {
                        animationTimingFunction: "cubic-bezier(0, 0, 0.2, 1)"
                    }),
                    "0%, 5%": _object_spread_props(_object_spread({}, rotateDeclarations(axis, "0deg")), {
                        animationTimingFunction: "ease-in"
                    }),
                    "50%": _object_spread_props(_object_spread({}, translateDeclarations(axis, "".concat(sign).concat(distance))), {
                        animationTimingFunction: "cubic-bezier(0.8, 0, 1, 1)"
                    }),
                    "50.1%": _object_spread_props(_object_spread({}, rotateDeclarations(axis, "".concat(sign, "180deg"))), {
                        animationTimingFunction: "linear"
                    }),
                    "95%, 100%": _object_spread_props(_object_spread({}, rotateDeclarations(axis, "".concat(sign, "360deg"))), {
